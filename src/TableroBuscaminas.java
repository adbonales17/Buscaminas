...
public class TableroBuscaminas {
    ...
    public int getNumBombasEntorno(int fila, int columna) {
    int contador = 0;
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (x >= 0 && x < numFilas && y >= 0 && y < numColumnas && casillas[x][y].isMina()) {
            contador++;
        }
    }
    ...
    void setEventoCasillaMarcada(Consumer<Integer> consumer) {
